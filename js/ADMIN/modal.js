    ...
    trigger.addEventListener("click", function (e) {
      ...
      fileInput.addEventListener("change", function () {
        ...
        if (size > 5) {
          ...
          output.innerHTML = "<b>" + "Image size: " + size + " MB" + "</b>";
...
// I added this script because when i use the modal-exit the cancel button's design gets changed
var cancelButtons = document.querySelectorAll(".cancel-button");

// Add a click event listener to each 'cancel-button' element
cancelButtons.forEach(function (cancelButton) {
  cancelButton.addEventListener("click", function () {
    ...
    // Hide the popup by removing the 'active' class
    modal.classList.remove("active");
    // Allow body scrolling when the popup is closed
    document.body.style.overflow = "auto";
