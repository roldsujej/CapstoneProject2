...
//     $query = "SELECT id, otp, otp_exp FROM account_profiles WHERE email ='$email'";
...
//             exit();
//         } else if (strtotime($otpExpiry) < time()) {
...
//             $sqlUpdateQry = "UPDATE account_profiles SET status = 1, user_role = 0 WHERE email = '$email' AND id = '$id'";

//             if (mysqli_query($conn, $sqlUpdateQry)) {
...
//                 exit();
//             } else {
//                 $_SESSION['msgError'] = "Database error: " . mysqli_error($conn);
//                 header("Location: verification.php"); // Redirect back to verification.php
...
//     $updateOTPQuery = "UPDATE account_profiles SET otp = '$newOTP', otp_exp = '$otp_expiration', user_role = 0 WHERE email = '$email'";
...
//         if ($mail->send()) { //pag nagsend yung email
...
//         exit();
//     } else {
//         $_SESSION['status'] = "Failed to resend OTP: " . mysqli_error($conn);
//         $_SESSION['status_code'] = "error";
//         header("Location: verification.php"); // Redirect back to verification.php
//         exit();
//     }
